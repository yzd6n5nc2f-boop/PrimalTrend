...
type WomenShopPageClientProps = {
  products: Product[];
};

export function WomenShopPageClient({ products }: WomenShopPageClientProps) {
    ...
    <div className="section-spacing">
      <div className="mx-auto max-w-[1280px] px-4 md:px-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="font-display text-3xl uppercase">Women</h1>
